{
    ...
    "ansible_date_time": {
        ...
        "epoch": "1581013258", 
        "hour": "12", 
        "iso8601": "2020-02-06T18:20:58Z", 
        "iso8601_basic": "20200206T122058664258", 
        "iso8601_basic_short": "20200206T122058", 
        "iso8601_micro": "2020-02-06T18:20:58.664358Z", 
        "minute": "20", 
        "month": "02", 
        "second": "58", 
        "time": "12:20:58", 
    ...
    "ansible_device_links": {
        "ids": {
            ...
            "dm-10": [
                "dm-name-vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot", 
                "dm-uuid-LVM-2SUId3edXeIKh994TfsDp2TLBtZP2FFSZ03gdWSa9JV1AQvb0qPcI9utC3ZNwghu"
            ], 
            "dm-13": [
    ...
    "ansible_devices": {
        ...
        "dm-8": {
            "holders": [
                ...
                "vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot"
            ], 
            "host": "", 
            "links": {
                "ids": [], 
            ...
            "partitions": {
                ...
                "sda4": {
                    "holders": [
                        ...
                        "vg--kvm-ceph_osd1", 
                        "vg--kvm-edalcosp01.elan.elantecs.com--disk1-real", 
                        "vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot-cow", 
    ...
    "ansible_env": {
        ...
        "SHELL": "/bin/bash", 
        "SHLVL": "1", 
        "SUDO_COMMAND": "/bin/sh -c echo BECOME-SUCCESS-prmyigkrepmibolxldulhrbvqhtimmxs ; /usr/bin/python", 
        "SUDO_GID": "12356", 
        "SUDO_UID": "12356", 
    ...
    "ansible_local": {
        ...
        "kvm_domains": {
            "virtual_vms": "['edalcosp01.elan.elantecs.com', 'edalcmnp01.elan.elantecs.com']"
        }, 
        "preference": {
            "private_fact": "blab"
        }, 
    ...
    "ansible_lvm": {
        "lvs": {
            ...
            "edalcosp01.elan.elantecs.com-disk1-snapshot": {
                "size_g": "4.00", 
                "vg": "vg-kvm"
            }, 
            "home": {
    ...
    "ansible_mounts": [
        {
            "block_available": 395995, 
            "block_size": 4096, 
            "block_total": 499668, 
            "block_used": 103673, 
            "device": "/dev/mapper/vg01-var", 
            "fstype": "ext4", 
            "inode_available": 126253, 
            "inode_total": 131072, 
            "inode_used": 4819, 
            "mount": "/var", 
            "options": "rw,relatime,data=ordered", 
            "size_available": 1621995520, 
        ...
        {
            "block_available": 1407396, 
            "block_size": 4096, 
            "block_total": 2031470, 
            "block_used": 624074, 
            "device": "/dev/mapper/vg01-root", 
            "fstype": "ext4", 
            "inode_available": 449099, 
            "inode_total": 524288, 
            "inode_used": 75189, 
            "mount": "/", 
            "options": "rw,relatime,data=ordered", 
            "size_available": 5764694016, 
        ...
        }, 
        {
            ...
            "inode_used": 0, 
            "mount": "/misc", 
            "options": "rw,relatime,fd=6,pgrp=4203,timeout=300,minproto=5,maxproto=5,indirect", 
            "size_available": 0, 
            "size_total": 0, 
            "uuid": "N/A"
        }, 
        {
            ...
            "inode_used": 0, 
            "mount": "/nfshome", 
            "options": "rw,relatime,fd=18,pgrp=4203,timeout=300,minproto=5,maxproto=5,indirect", 
            "size_available": 0, 
            "size_total": 0, 
            "uuid": "N/A"
        }
    ...
    "facter_macaddress_vnet0": "fe:54:00:d1:1a:83", 
    "facter_macaddress_vnet1": "fe:54:00:f4:a3:00", 
    ...
    "facter_memoryfree": "18.09 GB", 
    "facter_memoryfree_mb": "18520.58", 
    ...
    "ohai_filesystem": {
        ...
        "/dev/mapper/vg01-root": {
            "fs_type": "ext4", 
            "inodes_available": "449101", 
            "inodes_percent_used": "15%", 
            "inodes_used": "75187", 
            "kb_available": "5629592", 
            "kb_size": "8125880", 
            "kb_used": "2060476", 
            "mount": "/", 
            "mount_options": [
        ...
        "/dev/mapper/vg01-var": {
            "fs_type": "ext4", 
            "inodes_available": "126255", 
            "inodes_percent_used": "4%", 
            "inodes_used": "4817", 
            "kb_available": "1583988", 
            "kb_size": "1998672", 
            "kb_used": "293444", 
            "mount": "/var", 
            "mount_options": [
    ...
    "ohai_filesystem2": {
        "by_device": {
            ...
            "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot": {}, 
            "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot-cow": {}, 
            "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1-real": {}, 
            "/dev/mapper/vg01-home": {
                "fs_type": "ext4", 
                "inodes_available": "65497", 
                "inodes_percent_used": "1%", 
            ...
            "/dev/mapper/vg01-root": {
                "fs_type": "ext4", 
                "inodes_available": "449099", 
                "inodes_percent_used": "15%", 
                "inodes_used": "75189", 
                "kb_available": "5629584", 
                "kb_size": "8125880", 
                "kb_used": "2060484", 
                "mount_options": [
                    "rw", 
            ...
            "/dev/mapper/vg01-var": {
                "fs_type": "ext4", 
                "inodes_available": "126253", 
                "inodes_percent_used": "4%", 
                "inodes_used": "4819", 
                "kb_available": "1583980", 
                "kb_size": "1998672", 
                "kb_used": "293452", 
                "mount_options": [
                    "rw", 
        ...
        "by_mountpoint": {
            ...
            "/run": {
                ...
                "fs_type": "tmpfs", 
                "inodes_available": "3574665", 
                "inodes_percent_used": "1%", 
                "inodes_used": "754", 
                "kb_available": "14267980", 
                "kb_size": "14301676", 
                "kb_used": "33696", 
                "mount_options": [
                    "rw", 
        ...
        "by_pair": {
            ...
            "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot,": {
                "device": "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot"
            }, 
            "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot-cow,": {
                "device": "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1--snapshot-cow"
            }, 
            "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1-real,": {
                "device": "/dev/mapper/vg--kvm-edalcosp01.elan.elantecs.com--disk1-real"
            }, 
    ...
    "ohai_hostnamectl": {
        "architecture": "x86-64", 
        "boot_id": "dbb608dc799944e3b647b44b6e81123e", 
        "chassis": "server", 
        "cpe_os_name": "cpe", 
    ...
    "ohai_idletime": "31 days 15 hours 58 minutes 26 seconds", 
    "ohai_idletime_seconds": 2735906, 
    ...
    "ohai_memory": {
        "active": "11478328kB", 
        "anon_pages": "8970384kB", 
        "bounce": "0kB", 
        "buffers": "5334548kB", 
        "cached": "650720kB", 
        "commit_limit": "15350248kB", 
        "committed_as": "11636200kB", 
        "dirty": "1444kB", 
        "free": "12994876kB", 
        ...
        "page_tables": "25392kB", 
        "slab": "352604kB", 
        "slab_reclaimable": "312240kB", 
        "slab_unreclaim": "40364kB", 
        "swap": {
            "cached": "0kB", 
            "free": "1048572kB", 
            "total": "1048572kB"
        ...
        "total": "28603356kB", 
        "vmalloc_chunk": "34359272372kB", 
        "vmalloc_total": "34359738367kB", 
        "vmalloc_used": "360996kB", 
        "writeback": "0kB"
    }, 
    "ohai_network": {
    ...
    "ohai_uptime": "5 days 09 hours 19 minutes 18 seconds", 
    "ohai_uptime_seconds": 465558, 
    "ohai_virtualization": {
        "role": "host", 
        "system": "kvm", 
        "systems": {
