{
    ...
    "ansible_device_links": {
        "ids": {
            ...
            "dm-12": [
                "dm-name-vg--kvm-edalkbwp02.elan.elantecs.com--disk1", 
                "dm-uuid-LVM-2SUId3edXeIKh994TfsDp2TLBtZP2FFSknkFATKpkPNFVGoML0t1bh3xOXWvP6gc"
            ], 
            "dm-13": [
                "dm-name-vg--kvm-UrBackup_Vol1", 
                "dm-uuid-LVM-2SUId3edXeIKh994TfsDp2TLBtZP2FFSYSy3X6HuP6xr7pl0ANydPCcy2pLROYcr"
            ], 
            "dm-2": [
                "dm-name-vg01-opt", 
        ...
        "uuids": {
            ...
            "dm-13": [
                "005d9772-793a-4511-950b-aec2efa7c468"
            ], 
            "dm-2": [
            ...
            "partitions": {
                ...
                "sda4": {
                    "holders": [
                        ...
                        "vg--kvm-edalkbwp02.elan.elantecs.com--disk1", 
                        "vg--kvm-UrBackup_Vol1"
                    ], 
                    "links": {
                        "ids": [
                            "lvm-pv-uuid-9CPhN3-9D58-eKP6-otYa-xexO-RfOV-nzzCda", 
    ...
    "ansible_local": {
        ...
        "kvm_domains": {
            "virtual_vms": "['edalcmnp01.elan.elantecs.com', 'edalcosp01.elan.elantecs.com', 'edalngsp01.elan.elantecs.com', 'edalkbwp02.elan.elantecs.com']"
        }, 
        "preference": {
            "private_fact": "blab"
        }, 
    ...
    "ansible_lvm": {
        "lvs": {
            ...
            "edalkbwp02.elan.elantecs.com-disk1": {
                "size_g": "20.00", 
                "vg": "vg-kvm"
            }, 
    ...
    "ansible_mounts": [
        ...
        {
            "block_available": 420514, 
            "block_size": 4096, 
            "block_total": 499668, 
            "block_used": 79154, 
            "device": "/dev/mapper/vg01-opt", 
            "fstype": "ext4", 
            "inode_available": 118029, 
            "inode_total": 131072, 
            "inode_used": 13043, 
            "mount": "/opt", 
            "options": "rw,relatime,data=ordered", 
            "size_available": 1722425344, 
        ...
        }, 
        {
            ...
            "inode_used": 0, 
            "mount": "/misc", 
            "options": "rw,relatime,fd=6,pgrp=3861,timeout=300,minproto=5,maxproto=5,indirect", 
            "size_available": 0, 
            "size_total": 0, 
            "uuid": "N/A"
        }, 
        {
            ...
            "inode_used": 0, 
            "mount": "/nfshome", 
            "options": "rw,relatime,fd=18,pgrp=3861,timeout=300,minproto=5,maxproto=5,indirect", 
            "size_available": 0, 
            "size_total": 0, 
            "uuid": "N/A"
        }
    ...
    "facter_id": "root", 
    "facter_interfaces": "br0,eth0,eth1,eth2,eth3,eth4,eth5,eth6,eth7,lo,virbr0,virbr0_nic,vnet0,vnet1,vnet2,vnet3", 
    ...
    "facter_macaddress_vnet2": "fe:54:00:6f:52:09", 
    ...
    "ohai_filesystem": {
        ...
        "/dev/mapper/vg01-opt": {
            "fs_type": "ext4", 
            "inodes_available": "118029", 
            "inodes_percent_used": "10%", 
            "inodes_used": "13043", 
            "kb_available": "1682056", 
            "kb_size": "1998672", 
            "kb_used": "195376", 
            "mount": "/opt", 
            "mount_options": [
    ...
    "ohai_filesystem2": {
        "by_device": {
            ...
            "/dev/mapper/vg--kvm-edalkbwp02.elan.elantecs.com--disk1": {}, 
        ...
        "by_pair": {
            ...
            "/dev/mapper/vg--kvm-edalkbwp02.elan.elantecs.com--disk1,": {
                "device": "/dev/mapper/vg--kvm-edalkbwp02.elan.elantecs.com--disk1"
            }, 
            "/dev/mapper/vg--kvm-edalngsp01.elan.elantecs.com--disk1,": {
    ...
    "ohai_hostnamectl": {
        "architecture": "x86-64", 
        "boot_id": "10cb2cb77c9c4cbf80f6be52ef61b53e", 
        "chassis": "server", 
        "cpe_os_name": "cpe", 
    ...
    "ohai_memory": {
        ...
        "total": "28603356kB", 
        "vmalloc_chunk": "34359245204kB", 
        "vmalloc_total": "34359738367kB", 
        "vmalloc_used": "387584kB", 
        "writeback": "0kB"
    }, 
    "ohai_network": {
