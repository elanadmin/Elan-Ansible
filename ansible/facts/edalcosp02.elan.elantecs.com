{
    ...
    "ansible_date_time": {
        ...
        "epoch": "1580763598", 
        "hour": "14", 
        "iso8601": "2020-02-03T20:59:58Z", 
        "iso8601_basic": "20200203T145958499213", 
        "iso8601_basic_short": "20200203T145958", 
        "iso8601_micro": "2020-02-03T20:59:58.499342Z", 
        "minute": "59", 
        "month": "02", 
        "second": "58", 
        "time": "14:59:58", 
    ...
    "ansible_env": {
        ...
        "SHELL": "/bin/bash", 
        "SHLVL": "1", 
        "SUDO_COMMAND": "/bin/sh -c echo BECOME-SUCCESS-qaoufxxkimdwgqamnymccmvkxnyjdsbx ; /usr/bin/python", 
        "SUDO_GID": "12356", 
        "SUDO_UID": "12356", 
    ...
    "ansible_mounts": [
        {
            "block_available": 425232, 
            "block_size": 4096, 
            "block_total": 499668, 
            "block_used": 74436, 
            "device": "/dev/mapper/vg00-var", 
            "fstype": "ext4", 
            "inode_available": 115803, 
            "inode_total": 131072, 
            "inode_used": 15269, 
            "mount": "/var", 
            "options": "rw,relatime,data=ordered", 
            "size_available": 1741750272, 
            "size_total": 2046640128, 
            "uuid": "2b1e9f5d-ec6c-4a5a-9396-85caad79e1f6"
        }, 
        {
            "block_available": 231950, 
            "block_size": 4096, 
            "block_total": 249830, 
            "block_used": 17880, 
            "device": "/dev/mapper/vg00-home", 
            "fstype": "ext4", 
            "inode_available": 65489, 
            "inode_total": 65536, 
            "inode_used": 47, 
            "mount": "/home", 
            "options": "rw,relatime,data=ordered", 
            "size_available": 950067200, 
        ...
        {
            "block_available": 1265851, 
            "block_size": 4096, 
            "block_total": 2031470, 
            "block_used": 765619, 
            "device": "/dev/mapper/vg00-root", 
            "fstype": "ext4", 
            "inode_available": 424678, 
            "inode_total": 524288, 
            "inode_used": 99610, 
            "mount": "/", 
            "options": "rw,relatime,data=ordered", 
            "size_available": 5184925696, 
        ...
        }, 
        {
            ...
            "inode_used": 0, 
            "mount": "/misc", 
            "options": "rw,relatime,fd=6,pgrp=3332,timeout=300,minproto=5,maxproto=5,indirect", 
            "size_available": 0, 
            "size_total": 0, 
            "uuid": "N/A"
        }, 
        {
            ...
            "inode_used": 0, 
            "mount": "/nfshome", 
            "options": "rw,relatime,fd=18,pgrp=3332,timeout=300,minproto=5,maxproto=5,indirect", 
            "size_available": 0, 
            "size_total": 0, 
            "uuid": "N/A"
        }
    ...
    "facter_macaddress": "02:42:34:bc:f7:a7", 
    "facter_macaddress_docker0": "02:42:34:bc:f7:a7", 
    ...
    "facter_memoryfree": "3.24 GB", 
    "facter_memoryfree_mb": "3316.68", 
    ...
    "facter_uptime": "3:53 hours", 
    "facter_uptime_days": 0, 
    "facter_uptime_hours": 3, 
    "facter_uptime_seconds": 13986, 
    ...
    "ohai_filesystem": {
        ...
        "/dev/mapper/vg00-root": {
            "fs_type": "ext4", 
            "inodes_available": "424680", 
            "inodes_percent_used": "19%", 
            "inodes_used": "99608", 
            "kb_available": "5063412", 
            "kb_size": "8125880", 
            "kb_used": "2626656", 
            "mount": "/", 
            "mount_options": [
        ...
        "/dev/mapper/vg00-var": {
            "fs_type": "ext4", 
            "inodes_available": "115805", 
            "inodes_percent_used": "12%", 
            "inodes_used": "15267", 
            "kb_available": "1700936", 
            "kb_size": "1998672", 
            "kb_used": "176496", 
            "mount": "/var/lib/docker/overlay2", 
            "mount_options": [
    ...
    "ohai_filesystem2": {
        ...
        "by_mountpoint": {
            ...
            "/run": {
                ...
                "fs_type": "tmpfs", 
                "inodes_available": "484767", 
                "inodes_percent_used": "1%", 
                "inodes_used": "549", 
                "kb_available": "1908296", 
                "kb_size": "1941264", 
                "kb_used": "32968", 
                "mount_options": [
                    "rw", 
    ...
    "ohai_hostnamectl": {
        "architecture": "x86-64", 
        "boot_id": "31df0a0878be42119a25c975aa242d59", 
        "chassis": "vm", 
        "cpe_os_name": "cpe", 
    ...
    "ohai_idletime": "15 hours 16 minutes 12 seconds", 
    "ohai_idletime_seconds": 54972, 
    ...
    "ohai_memory": {
        ...
        "page_tables": "8796kB", 
        "slab": "141476kB", 
        "slab_reclaimable": "123220kB", 
        "slab_unreclaim": "18256kB", 
        "swap": {
            "cached": "0kB", 
            "free": "1048572kB", 
            "total": "1048572kB"
    ...
    "ohai_uptime": "3 hours 53 minutes 03 seconds", 
    "ohai_uptime_seconds": 13983, 
    "ohai_virtualization": {
        "role": "guest", 
        "system": "kvm", 
        "systems": {
